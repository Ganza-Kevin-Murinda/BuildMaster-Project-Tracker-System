...
public class TaskServiceImpl implements TaskService {
    ...
    @Override
    public List<TaskResponseDTO> getTasksByDeveloperId(UUID developerId) {
    ...
    @Override
    public List<TaskResponseDTO> getTasksByDueDateRange(LocalDate startDate, LocalDate endDate) {
        log.debug("Fetching tasks by due date range: {} to {}", startDate, endDate);
