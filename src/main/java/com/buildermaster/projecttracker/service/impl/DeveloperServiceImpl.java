...
public class DeveloperServiceImpl implements DeveloperService {
    ...
    @Override
    public DeveloperResponseDTO createDeveloper(CreateDeveloperRequestDTO createRequest) {
        log.info("Creating new developer with email: {}", createRequest.getEmail());

        // Validate email uniqueness
        if (developerRepository.existsByEmail(createRequest.getEmail())) {
        ...
        // Log audit
        auditService.logAction(EActionType.CREATE, ENTITY_TYPE, savedDeveloper.getId(), SYSTEM_ACTOR, savedDeveloper);
    ...
    public DeveloperResponseDTO updateDeveloper(UUID developerId, UpdateDeveloperRequestDTO updateRequest) {
